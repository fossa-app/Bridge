          ...
          testList
              ...
              [ testCase "string sections and no query parameters"
                ...
                <| fun _ ->
                    ...
                    Expect.equal
                        result
                        "api/1.0/users?limit=10&offset=20"
                ...
                <| fun _ ->
                    ...
                    Expect.equal
                        result
                        "api/1.0/users?filter=active&filter=admin"
                ...
                <| fun _ ->
                    ...
                    Expect.equal
                        result
                        "api/1.0/9223372036854775807?id=1234567890123456789"
                ...
                <| fun _ ->
                    ...
                    Expect.equal
                        result
                        "api/1.0/12345678-1234-1234-1234-123456789012?ref=87654321-4321-4321-4321-210987654321"
